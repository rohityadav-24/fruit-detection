                    ...
                    <Grid item xs={12} lg={12}>
                        <BaseCard title="Order Details">
                            <Box>
                                ...
                                <Typography component="div" sx={{ fontSize: "h4.fontSize", fontWeight: "500" }}><Typography color={"primary"} sx={{ fontWeight: "bold" }} component={"span"}>Payment Mode : </Typography>{response.data.mode}</Typography>
